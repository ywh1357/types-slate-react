...
export type EventHook<T extends React.SyntheticEvent = React.SyntheticEvent> = (
    event: T,
    editor: CoreEditor,
    next: () => any
) => any;
...
export interface Plugin {
    ...
    onBeforeInput?: EventHook<React.CompositionEvent>;
    onBlur?: EventHook;
...
export interface ChangeHandler {
    (change: { operations: Immutable.List<Operation>, value: Value }): any
}
